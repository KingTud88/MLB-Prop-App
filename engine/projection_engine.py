...
class ProjectionEngine:
    ...
    def _line_cutoff(line: float) -> int:
        """Map a milestone/prop threshold to the minimum integer strikeout total that wins.

        Integer milestones use their own value (3+ => K >= 3), while half-lines
        round up (5.5 => K >= 6).
        """
