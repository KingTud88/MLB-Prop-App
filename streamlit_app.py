...
.sok-hero:before{content:"";position:absolute;inset:-.2rem 0;border:1px solid #294866;border-radius:20px;background:radial-gradient(circle at 15% 48%,rgba(227,24,55,.18),transparent 25%),radial-gradient(circle at 72% 30%,rgba(30,74,130,.18),transparent 30%),linear-gradient(145deg,rgba(9,29,51,.72),rgba(4,15,29,.2));z-index:-1}
.sok-hero [data-testid="stImage"] img{display:block!important;max-height:295px!important;width:255px!important;height:295px!important;object-fit:contain!important;margin:0 auto!important;filter:drop-shadow(0 18px 22px rgba(0,0,0,.5))!important}
...
.matchup .pitcher{font-family:Impact,Haettenschweiler,"Arial Narrow Bold",sans-serif!important;font-size:2.35rem!important}
...
@media(max-width:700px){.sok-hero{grid-template-columns:1fr!important;min-height:0!important;text-align:center!important}.sok-hero [data-testid="stImage"] img{width:190px!important;height:190px!important}.sok-title{font-size:3.4rem!important;white-space:normal!important}}
</style>
'''
