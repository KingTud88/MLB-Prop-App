...
with col1:
    ...
    # RELOCATED: The Automated Tracker is placed right below the arsenal matrix inside column 1
...
# FIXED: This closing bracket closes column 1 perfectly, letting column 2 mount side-by-side
with col2:
