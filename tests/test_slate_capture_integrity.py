...
WORKFLOW = Path(".github/workflows/slate-capture-integrity.yml")
...
def test_slate_integrity_workflow_can_only_persist_from_main() -> None:
    text = WORKFLOW.read_text(encoding="utf-8")
    assert "branches: [main]" in text
    assert "if: success() && github.ref == 'refs/heads/main'" in text
