...
if st is not None:
    ...
    .sok-sidebar-title span{color:var(--sok-red)!important}.sok-sidebar-sub{color:#b8c8d9!important}
    .sok-nav .active{background:linear-gradient(90deg,#ed1838,#bd0d2b)!important;box-shadow:0 5px 14px rgba(227,24,55,.2)!important}.sok-nav a:hover{background:#102b4c!important}
    .sok-side-card,.sok-date{border-color:#35536f!important;background:linear-gradient(145deg,#0a2039,#061528)!important}.sok-search-title,.sok-date .label,.sok-side-card .title{color:#ff2948!important}
    ...
    .sok-hero [data-testid="stImage"]{position:relative!important;z-index:3!important;transform:scale(1.18)!important;transform-origin:center center!important;filter:drop-shadow(0 18px 20px rgba(0,0,0,.45))!important}.sok-hero [data-testid="stImage"] img{max-height:285px!important;width:auto!important;object-fit:contain!important}
    .sok-title{font-family:Impact,"Arial Narrow",sans-serif!important;font-size:5.9rem!important;line-height:.78!important;letter-spacing:.015em!important;color:#f7f8fa!important;text-shadow:4px 4px 0 #172d4f,0 12px 25px rgba(0,0,0,.35)!important}.sok-title .red{color:var(--sok-red)!important;text-shadow:3px 3px 0 #f7f8fa,6px 6px 0 #152b4c,0 13px 24px rgba(0,0,0,.35)!important}
    .sok-ribbon{margin-top:.8rem!important;border:2px solid var(--sok-red)!important;background:#081a31!important;box-shadow:0 8px 20px rgba(227,24,55,.18)!important}.sok-status{border:1px solid #3a5773!important;background:linear-gradient(145deg,#0d2746,#07182c)!important;box-shadow:0 14px 26px rgba(0,0,0,.25)!important}.sok-status:before{content:"BUILT FOR\\A CLE BASEBALL"!important}
    .matchup{border:2px solid #35536f!important;border-radius:17px!important;background:linear-gradient(145deg,#0b2440,#06162a)!important;box-shadow:0 16px 30px rgba(0,0,0,.25)!important}.matchup .pitcher{font-family:Impact,"Arial Narrow",sans-serif!important;font-size:2.2rem!important}.matchup .teams{color:var(--sok-red2)!important}.cle-badge{width:82px!important;height:82px!important;border-color:#405c78!important;background:radial-gradient(circle,#19365e,#07172b)!important;color:#fff!important;text-shadow:3px 3px 0 var(--sok-red)!important}.live-schedule .head{color:#2fe777!important}
